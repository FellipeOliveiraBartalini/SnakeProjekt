...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            if event.key == K_ESCAPE:
                pygame.quit()
                print('Jogo Finalizado! Obrigado por Testar!!')
    ...
    if pos[0] == 590:
        print('Traumatismo Craniano!1') #Direita
        exit()

    if pos[0] == 0:
        print('Traumatismo Craniano!2') #Esquerda
        exit()

    if pos[1] == 590:
        print('Traumatismo Craniano!3') #Embaixo
        exit()

    if pos[1] == 0:
        print('Traumatismo Craniano!4') #Emcima
        exit()
